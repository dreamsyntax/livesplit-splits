...
<Layout version="1.6.1">
  ...
  <X>2</X>
  <Y>0</Y>
  <VerticalWidth>524</VerticalWidth>
  <VerticalHeight>506</VerticalHeight>
  <HorizontalWidth>-1</HorizontalWidth>
  <HorizontalHeight>-1</HorizontalHeight>
  <Settings>
    <TextColor>FFFFFFFF</TextColor>
    <BackgroundColor>FF580000</BackgroundColor>
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>C:\Users\user\Documents\Speedrunning\LiveSplit-ASL-Scripts-CrashSupport\ShadowTheHedgehog\ShadowTheHedgehog-Dolphin.asl</ScriptPath>
        <Start>True</Start>
        <Reset>False</Reset>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="features" type="bool">False</Setting>
          <Setting id="debug_stdout" type="bool">False</Setting>
          <Setting id="behaviour" type="bool">True</Setting>
          <Setting id="o_autostart" type="bool">True</Setting>
          <Setting id="o_autoreset" type="bool">False</Setting>
          <Setting id="o_halfframerate" type="bool">True</Setting>
        </CustomSettings>
      </Settings>
    </Component>
  </Components>
